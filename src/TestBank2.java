...
// #2 Create customer
        ...
        testingCreateCustomer(customerName, customerSurname, personalNumber,
                true);
// #3 Create customer
        customerName = "Karl";
...
// #12 Change a name for a customer that don't exists
        ...
        testingChangeName(customerName, customerSurname, personalNumber,
                false);
...
// #52 Get transactions
        testingGetTransactions(personalNumber, 1005, "[" + strDate1005_1 + " 1 000,00 kr Saldo: 1 000,00 kr, " + strDate1005_2 + " -100,00 kr Saldo: 900,00 kr, "
            + strDate1005_3 + " -102,00 kr Saldo: 798,00 kr]");
...
// #75 No customers left...
     ...
     * @param facit - the facit that we compares with
     */
...
// Give feedback to the user
     ...
     * @param facit - true if customer should be created otherwice false
     */
    private void testingCreateCustomer(String name, String surname, String pNo,
                                       boolean facit)
    {
// Just check if we get the right value back and give feedback to the user
     ...
     */
    private void testingChangeName(String name, String surname, String pNo,
                                   boolean facit)
    {
// Just check if we get the right value back and give feedback to the user
...
// Check if we get the right value back and give feedback to the user
     ...
     */
    private void testingDeposit(String pNo, int accountId, int amount, boolean
            facit)
    {
// Check if we get the right value back and give feedback to the user
        ...
        {
            System.out.println("Test " + testCounter++ + ": FAIL - deposit("+
                    pNo +", "+ accountId+", " + amount +")");
        }
    }
    /**
     ...
     */
    private void testingWithdraw(String pNo, int accountId, int amount, boolean
            facit)
    {
// Check if we get the right value back and give feedback to the user
